    ...
    public CanSpeak toCanSpeak(final int i) {
        ...
        class DogPet extends SuperDog implements CanSpeak{
            ...
            private String getName(){
                ...
                if(i < 1){
                    result.append(this.getSuperQuotes()).append(name).append(this.getSuperQuotes()).append(" is sleeping.");

                    return result.toString();
                } else {
                    result.append(this.getSuperQuotes()).append(name).append(this.getSuperQuotes());
                    result.append(" says r");
                    for (int z = 0; z < i; z++){
                        result.append("u");
                    }
                    result.append("ff!");
